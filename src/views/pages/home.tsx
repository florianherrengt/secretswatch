					...
					<div class="mx-auto flex min-h-screen max-w-6xl flex-col px-4 sm:px-6">
						...
						<section class="flex flex-1 items-center justify-center py-8">
							<div class="w-full max-w-4xl rounded-xl border border-border bg-card p-5 sm:p-6">
								...
								<form id="scan-form" action="/scan" method="post" class="flex gap-3">
									<input id="visitorFingerprint" name="visitorFingerprint" type="hidden" value="" />
									<input
										id="domain"
										name="domain"
										type="text"
						...
						<footer class="py-6 text-center text-sm text-muted-foreground">
							...
							<span> · </span>
							<a href="/terms" class="text-muted-foreground underline">
								Terms of Service
							</a>
							<span> · </span>
							<a href="/privacy" class="text-muted-foreground underline">
								Privacy Policy
							</a>
						</footer>
					</div>
