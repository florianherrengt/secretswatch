					...
					<div class="space-y-6">
						...
						<div class="space-y-3">
							...
							<p class="text-base text-foreground">
								By accessing or using Secrets Watch ("the Service"), you agree to be bound by these
								Terms of Service. If you do not agree to all of these terms, do not use the Service.
							</p>
						</div>
						<div class="space-y-3">
							<h2 class="text-xl font-semibold text-foreground">2. Description of Service</h2>
							<p class="text-base text-foreground">
								Secrets Watch is a web-based security scanning tool that analyzes publicly
								accessible websites for exposed secrets, credentials, and security vulnerabilities.
								The Service performs point-in-time scans of URLs you submit and reports findings.
							</p>
						</div>
						<div class="space-y-3">
							...
							<p class="text-base text-foreground">
								...
								represent that you are at least 16 years old and have the legal capacity to enter
								into these terms.
							</p>
						</div>
						<div class="space-y-3">
							...
							<p class="text-base text-foreground">
								The Service requires an account to access certain features. You must provide a valid
								email address. You are responsible for maintaining the security of your account and
						...
						<div class="space-y-3">
							...
							<ul class="list-disc pl-6 space-y-1">
								<li>
									Scan websites or URLs that you do not own or have explicit authorization to scan
								</li>
						...
						<div class="space-y-3">
							...
							<p class="text-base text-foreground">
								You are solely responsible for the URLs and domains you submit for scanning. You
								represent that you have the legal right and authorization to scan any URL you
								submit. We are not responsible for any misuse of the scanning functionality.
							</p>
						</div>
						<div class="space-y-3">
							<h2 class="text-xl font-semibold text-foreground">7. Scan Results Disclaimer</h2>
							<p class="text-base text-foreground">
								Scan results are provided for informational purposes only. The Service performs
								point-in-time analysis and does NOT guarantee:
							</p>
							<ul class="list-disc pl-6 space-y-1">
							...
							<p class="text-base text-foreground">
								You should not rely solely on the Service for security assessments. Results should
								be verified through independent security audits.
							</p>
						</div>
						<div class="space-y-3">
							...
							<p class="text-base text-foreground">
								...
								Secrets Watch and are protected by copyright, trademark, and other intellectual
								property laws. Your use of the Service does not transfer any ownership rights.
							</p>
						</div>
						<div class="space-y-3">
							...
							<p class="text-base text-foreground">
								IN NO EVENT SHALL SECRETS WATCH BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL,
							...
							<p class="text-base text-foreground">
								...
								SHALL NOT EXCEED THE AMOUNT YOU PAID TO USE THE SERVICE DURING THE TWELVE (12)
								MONTHS PRIOR TO THE EVENT GIVING RISE TO THE LIABILITY, OR ONE HUNDRED DOLLARS
						...
						<div class="space-y-3">
							...
							<p class="text-base text-foreground">
								You agree to defend, indemnify, and hold harmless Secrets Watch from and against any
								and all claims, damages, obligations, losses, liabilities, costs, or debt arising
								from:
							</p>
							<ul class="list-disc pl-6 space-y-1">
						...
						<div class="space-y-3">
							...
							<p class="text-base text-foreground">
								...
								use the Service will immediately cease. Provisions of these Terms that by their
						...
						<div class="space-y-3">
							...
							<p class="text-base text-foreground">
								...
								rules. You agree to arbitrate all disputes with us on an individual basis only — not
								as a class action, collective action, or representative action. You waive any right
								to participate in a class action lawsuit or class-wide arbitration against us. You
								agree that you may bring claims against us only in your individual capacity and not
						...
						<div class="space-y-3">
							...
							<p class="text-base text-foreground">
								...
								jurisdiction, without regard to conflict of law principles. If any provision of
								these Terms is found to be unenforceable, the remaining provisions will remain in
